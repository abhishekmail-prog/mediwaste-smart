      ...
      switch (s.label) {
        case 0:
          ...
          if (a = e.version.toFixed(2), r = e.alpha ? e.alpha.toFixed(2) : "", o = -1, i = 1, null == e.modelUrl) {
            ...
            if (!(r in MODEL_INFO[a]))
              throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(MODEL_INFO[a]) + ".");
