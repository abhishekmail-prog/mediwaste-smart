  ...
  "node_modules/papaparse/papaparse.min.js"(exports, module) {
    ((e, t) => {
      ...
      function u(e) {
        this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = { data: [], errors: [], meta: {} }, (function(e2) {
          ...
          if (!this._handle.paused() && !this._handle.aborted()) {
            ...
            if (a)
              n.postMessage({ results: r2, workerId: w.WORKER_ID, finished: i2 });
          ...
          if (p2 && a2 && (k("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + w.DefaultDelimiter + "'"), a2 = false), m2.skipEmptyLines && (p2.data = p2.data.filter(function(e3) {
            ...
            if (p2)
              if (Array.isArray(p2.data[0])) {
                for (var e2 = 0; g2() && e2 < p2.data.length; e2++)
        ...
        U(m2.step) && (t = m2.step, m2.step = function(e2) {
          ...
          var r3 = m2.quoteChar || '"', r3 = (m2.newline || (m2.newline = this.guessLineEndings(e2, r3)), a2 = false, m2.delimiter ? U(m2.delimiter) && (m2.delimiter = m2.delimiter(e2), p2.meta.delimiter = m2.delimiter) : ((r3 = ((e3, t3, i4, r4, n3) => {
            ...
            for (var u3 = 0; u3 < n3.length; u3++) {
              for (var d3, l3 = n3[u3], f3 = 0, c3 = 0, p3 = 0, _3 = (o3 = void 0, new E({ comments: r4, delimiter: l3, newline: t3, preview: 10 }).parse(e3)), g3 = 0; g3 < _3.data.length; g3++)
                i4 && y(_3.data[g3]) ? p3++ : (d3 = _3.data[g3].length, c3 += d3, void 0 === o3 ? o3 = d3 : 0 < d3 && (f3 += Math.abs(d3 - o3), o3 = d3));
      ...
      function E(C) {
        ...
        if (void 0 !== C.escapeChar && (z = C.escapeChar), ("string" != typeof S || -1 < w.BAD_DELIMITERS.indexOf(S)) && (S = ","), x === S)
        ...
        this.parse = function(i2, t, r2) {
          ...
          if (A || false !== A && -1 === i2.indexOf(F)) {
            for (var f2 = i2.split(O), c2 = 0; c2 < f2.length; c2++) {
              if (d2 = f2[c2], M += d2.length, c2 !== f2.length - 1)
                M += O.length;
              else if (r2)
                return b();
              if (!x || d2.substring(0, a2) !== x) {
                if (o2) {
                  if (h2 = [], k(d2.split(S)), R(), j)
                    return b();
                } else
                  k(d2.split(S));
                if (I && I <= c2)
                  return h2 = h2.slice(0, I), b(true);
              }
            }
            return b();
          }
          for (var p2 = i2.indexOf(S, M), _2 = i2.indexOf(O, M), g2 = new RegExp(P(z) + P(F), "g"), m2 = i2.indexOf(F, M); ; )
            if (i2[M] === F)
              for (m2 = M, M++; ; ) {
                if (-1 === (m2 = i2.indexOf(F, m2 + 1)))
                  return r2 || u2.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: M }), E2();
                if (m2 === n2 - 1)
                  return E2(i2.substring(M, m2).replace(g2, F));
                if (F === z && i2[m2 + 1] === z)
                  m2++;
                  ...
                  if (i2.substring(m2 + 1 + y, m2 + 1 + y + s2) === O) {
                    if (d2.push(i2.substring(M, m2).replace(g2, F)), v2(m2 + 1 + y + s2), p2 = i2.indexOf(S, M), m2 = i2.indexOf(F, M), o2 && (R(), j))
                      return b();
                    if (I && h2.length >= I)
                      return b(true);
                    break;
            ...
            } else if (-1 !== p2 && (p2 < _2 || -1 === _2))
              d2.push(i2.substring(M, p2)), M = p2 + e, p2 = i2.indexOf(S, M);
            else {
              if (-1 === _2)
                break;
              if (d2.push(i2.substring(M, _2)), v2(_2 + s2), o2 && (R(), j))
                return b();
              if (I && h2.length >= I)
                return b(true);
            }
      ...
      return w.parse = function(e, t) {
        ...
        if (t.dynamicTyping = i2, t.transform = !!U(t.transform) && t.transform, void 0 !== t.downloadTimeout) {
          ...
          if (isNaN(i2))
            throw new Error("Config downloadTimeout value (" + t.downloadTimeout + ") not parsable by parseInt(val).");
          t.downloadTimeout = i2;
        }
        if (!t.worker || !w.WORKERS_SUPPORTED)
          return i2 = null, w.NODE_STREAM_INPUT, "string" == typeof e ? (e = q(e), i2 = new (t.download ? d : f)(t)) : true === e.readable && U(e.read) && U(e.on) ? i2 = new c(t) : (n.File && e instanceof File || e instanceof Object) && (i2 = new l(t)), i2.stream(e);
        (i2 = (() => {
          var e2;
